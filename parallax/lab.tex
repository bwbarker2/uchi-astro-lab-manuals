...
%	\item Use the $t'$ statistic described in Appendix\ \ref{unc:sec:comparing} to compare the two values and interpret the result --- do these two ways of distance measurement really measure the same thing?
	\item Use the $t'$ statistic described in Appendix~B.3 to compare the two values and interpret the result --- do these two ways of distance measurement really measure the same thing? % With fixed apendix for different document
\end{steps}
...
Include the following in your lab report. See Appendix~A for formatting details. Each item below is worth 10 points. % Fixed appendix numbers
...
\begin{enumerate}
	...
	\item Final determined value of the distance and comparison with the direct distance using percent difference and $t'$ statistic. Show your work (see Appendix~A). %\ref{cha:lab-report-format}).
