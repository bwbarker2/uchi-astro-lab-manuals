...
%todo include better instructions for using SciDaVis, maybe link to a video tutorial

%todo include discussion of how doppler shifts are used to find the radial velocity?
