...
%TODO rename lab to "Intro to Radioactivity" to remove confusion about two-week lab
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Record the counts and elapsed time in each interval in a spreadsheet and calculate the count rate in counts per half-minute.
	\end{enumerate}
